            ...
            <el-row>
                   ...
                   <el-col :span="24">
                       ...
                       <div v-else>
                        ...
                        <el-col :span="12">
                            <el-form-item class="date" v-if="type!='info'" label="公告时间" prop="riqi">
                                <el-date-picker
                            ...
                            <div v-else>
                                <el-form-item class="input" v-if="ruleForm.insertTime" label="公告时间" prop="insertTime">
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        createTime: [
                        { required: true, message: '创建时间 show2 show1 nameShow不能为空', trigger: 'blur' },
                    ],
            },
