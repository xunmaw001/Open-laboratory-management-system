    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                       <el-form-item class="select" v-if="type!='info'"  label="父字段id" prop="superTypes">
                           <el-select v-model="ruleForm.superTypes" placeholder="请选择父字段id">
                               <el-option
                                       v-for="(item,index) in superTypesSelectSearch"
                                       v-bind:key="index"
                       ...
                       <div v-else>
                           <el-form-item class="input" label="父字段id" prop="superTypes">
                               <el-select v-model="ruleForm.superTypes" placeholder="请选择父字段id" readonly>
                                   <el-option
                                           v-for="(item,index) in superTypesSelectSearch"
                                           v-bind:key="index"
                                           :label="item.indexName"
