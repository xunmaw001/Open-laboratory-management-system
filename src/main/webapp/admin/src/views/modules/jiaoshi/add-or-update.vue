        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="教师编号" prop="jiaoshiBianhao">
                              <el-input v-model="ruleForm.jiaoshiBianhao"
                                        placeholder="教师编号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                   ...
                   <el-col :span="12">
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="身份证号" prop="jiaoshiNumber">
                              <el-input v-model="ruleForm.jiaoshiNumber"
                                        placeholder="身份证号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="身份证号" prop="jiaoshiNumber">
                                  <el-input v-model="ruleForm.jiaoshiNumber"
                   ...
                   <el-col :span="24">
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="教师部门" prop="jiaoshiBumen">
                              <el-input v-model="ruleForm.jiaoshiBumen"
                                        placeholder="教师部门" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="教师部门" prop="jiaoshiBumen">
                                  <el-input v-model="ruleForm.jiaoshiBumen"
                                            placeholder="教师部门" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
            </el-row>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        jiaoshiBumen: [
                        { required: true, message: '教师部门不能为空', trigger: 'blur' },
                    ],
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='jiaoshiNumber'){
                                     this.ruleForm.jiaoshiNumber = obj[o];
                                     this.ro.jiaoshiNumber = true;
                                     continue;
                                 }
                                 ...
                                 if(o=='jiaoshiBumen'){
                                     this.ruleForm.jiaoshiBumen = obj[o];
                                     this.ro.jiaoshiBumen = true;
                                     continue;
                                 }
