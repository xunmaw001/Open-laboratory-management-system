    ...
    <div>
        ...
        >
            <el-row>
				...
				<el-col :span="12">
				    <el-form-item v-if="flag=='jiaoshi'" label="用户名" prop="username">
				        <el-input v-model="ruleForm.username" readonly placeholder="用户名" clearable></el-input>
				    </el-form-item>
				</el-col>
				<el-col :span="12">
				    <el-form-item v-if="flag=='jiaoshi'" label="姓名" prop="jiaoshiName">
				        <el-input v-model="ruleForm.jiaoshiName" placeholder="姓名" clearable></el-input>
				    </el-form-item>
				</el-col>
				<el-col :span="24">
				    <el-form-item v-if="flag=='jiaoshi'" label="头像" prop="jiaoshiPhoto">
				        <file-upload
				                ...
				                @change="jiaoshijiaoshiPhotoUploadChange"
				        ></file-upload>
				    </el-form-item>
				</el-col>
				<el-col :span="12">
				    <el-form-item v-if="flag=='jiaoshi'" label="性别" prop="sexTypes">
				        <el-select v-model="ruleForm.sexTypes" placeholder="请选择性别">
				            <el-option
				                    v-for="(item,index) in sexTypesSelectSearch"
				                    v-bind:key="index"
				...
				<el-col :span="12">
				    <el-form-item v-if="flag=='jiaoshi'" label="联系电话" prop="jiaoshiPhone">
				        <el-input v-model="ruleForm.jiaoshiPhone" placeholder="联系电话" clearable></el-input>
				    </el-form-item>
				</el-col>
